...
export default function Submit() {
  ...
  return (
    <div className="profile">
      <div className="mb-8">
        {isLoggedIn ? (
          <div className="prof md:px-[10%] lg:px-[10%] px-[2%]">
            <div className=" max-w-[1400px] mx-auto">
              ...
              <div className="flex flex-col md:flex-row lg:flex-row gap-4 md:gap-8 lg:gap-x-14 mt-10 w-full">
                <Link to={"/submit/tool"} className="w-full">
                  <div className="flex bg-white  items-center  rounded-xl w-full md:w-full lg:w-full  shadow-xl">
                ...
                <Link to={"/submit/sponsor"} className="w-full">
                  <div className="flex bg-white  items-center space-x-4 md:space-x-8 rounded-xl w-full md:w-full lg:w-full  shadow-xl">
