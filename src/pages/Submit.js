...
export default function Submit() {
  ...
  return (
    <div className="profile">
      <div className="mb-8">
        {isLoggedIn ? (
          <div className="prof md:px-[5%] lg:px-[10%] px-[2%]">
            <div className=" max-w-[1400px] mx-auto">
              <div cassName="proftext">
                <h1 className="txtclr text-[24px] font-mont  font-semibold">
                  Hi! <span className="aitxt">{res}</span>,
                </h1>
              </div>

              <h2 className="txtclr font-semibold text-[40px] mt-4 font-mont">
                Dashboard
              </h2>
              ...
              <div className="flex flex-col md:flex-row lg:flex-row gap-4 md:gap-8 lg:gap-x-14 mt-10 w-full">
                <Link to={"/submit/tool"} className="w-full">
                  <div className="flex   items-center  rounded-xl w-full md:w-full lg:w-full  shadow-xl">
                    <div className="submitproff">
                      <div className="svg">
                        <FiPlusSquare className="bsbook" />
                      </div>
                      <div></div>
                      <div className="flex flex-col space-y-4">
                        <h3 className="font-mont aitxt underline underline-offset-[7px] md:text-[32px] lg:text-[32px] text-[26px] font-semibold leading-[39.01px]">
                          Submit Tool
                        </h3>
                        <p className="md:text-[10px] lg:text-[14px] text-[10px] leading-[17.01px] font-mont">
                          Discover the potential of your tool by effortlessly
                          gaining exposure through our directory. Elevate your
                          outreach in just a few easy steps. Embrace the
                          opportunity to join our directory now and broaden your
                          reach.
                        </p>
                        <Link
                          to={"/submit/tool"}
                ...
                <Link to={"/submit/sponsor"} className="w-full">
                  <div className="flex bg-black  items-center space-x-4 md:space-x-8 rounded-xl w-full md:w-full lg:w-full  shadow-xl">
                    <div className="submitprof">
                      <div>
                        <TbUserDollar className="bsbook" />
                      </div>
                      <div className="flex flex-col space-y-4">
                        ...
                        <p className="md:text-[10px] lg:text-[14px] text-[10px] leading-[17.01px] font-mont">
                          Amplify your brand's reach with our Instagram Reel
                          Mention Sponsorship and Newsletter Sponsorship. Get
                          featured among the top 5 tools in our Instagram Reel
                          content and gain prominent visibility in our daily
                          newsletter as a sponsor. Join us now for maximum
                          impact!
                        </p>
                        <Link
                          to={"/submit/sponsor"}
              ...
              <div className="flex flex-col md:flex-row lg:flex-row gap-4 md:gap-8 lg:gap-x-14 lg:mt-12 md:mt-10 mt-6 w-full">
                <Link to={"/submit/bookmark"} className="w-full">
                  <div className="flex bg-white  items-center space-x-4 md:space-x-8 rounded-xl w-full  shadow-xl">
                    <div className="submitprof">
                      <div>
                        {/* <svg
                    width="57"
                  ...
                  >
                    ...
                    />
                        ...
                        <BsFillBookmarkFill className="bsbook" />
                      </div>
                      <div className="flex  flex-col space-y-4">
                        <h3 className="font-mont underline underline-offset-[7px] md:text-[32px] lg:text-[32px] text-[26px] font-semibold leading-[39.01px]">
                          Bookmarks
                        ...
                        <p className="md:text-[10px] lg:text-[14px] text-[10px] leading-[17.01px] font-mont">
                          Explore and access your favorite AI resources in one
                          place! Organize your bookmarks for quick and easy
                          retrieval, simplifying your AI exploration with just a
                          few clicks. Stay efficient and informed with our
                          curated collection at your fingertips.
                        </p>
                        <Link
                          to={"/submit/bookmark"}
                          className="mr-auto text-[18px] font-bold font-mont"
          ...
          <div className="md:px-[5%] lg:px-[10%] px-[5%]">
            <h1 className="text-[30px] txtclr mt-32 md:text-[44px] lg:text-[44px] sm:text-[30px] logintxt font-semibold text-center font-mont leading-snug">
              Submit New AI Tool
            </h1>
            <div className="mt-8">
              <div className="logintext txtclr text-[18px] font-mont font-semibold text-center leading-normal md:leading-[24px] lg:leading-[28px] flex flex-col space-y-3 px-4 md:px-8 lg:px-16 xl:px-24">
                ...
                <p className="text-base md:text-lg lg:text-xl">
                  Continue with your Social Integration with Google. It will
                  only take a blip of a second. By creating the account you will
                  be able to access the submission process and manage your
                  Tools.
                </p>
              </div>
              ...
              <div className="loginbg text-white font-mont text-[18px] p-6 mt-12 mb-12 text-justify rounded-2xl leading-[21.94px] flex flex-col space-y-5">
                ...
                <p className="font-medium">
                  ...
                  account is ready, log in and head to the "Submit Tool"
                  section.
                </p>
                <p className="font-medium">
                  <span className="font-bold">
                    Step 2: Provide Tool Details
                  </span>{" "}
                  - In the "Submit Tool" section, you can furnish all the
                  essential details about your tool. We encourage you to provide
                  a comprehensive description, use-cases, and any other relevant
                  information that will help users understand the value and
                  functionality of your tool.
                </p>
                <p className="font-medium">
                  By following these simple steps, you can showcase your tool to
                  a broader audience and gain recognition for your innovation.
                  We believe that this process will help your tool thrive while
                  supporting the growth and sustainability of our platform.
