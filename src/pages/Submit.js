            ...
            <div className="flex bg-white px-7 py-12 items-center space-x-4 md:space-x-8 rounded-xl w-full md:w-full lg:w-full h-[300px] shadow-xl">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <p className="md:text-[14px] lg:text-[14px] text-[10px] leading-[17.01px] font-mont">
                  ...
                  exposure through our directory. Elevate your outreach in just
                  a few easy steps. Embrace the opportunity to join our
            ...
            <div className="flex bg-white px-7 py-12 items-center space-x-4 md:space-x-8 rounded-xl w-full md:w-full lg:w-full h-[300px] shadow-xl">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <p className="md:text-[14px] lg:text-[14px] text-[10px] leading-[17.01px] font-mont">
                  ...
                  Sponsorship and Newsletter Sponsorship. Get featured among the
                  top 5 tools in our Instagram Reel content and gain prominent
                  visibility in our daily newsletter as a sponsor. Join us now
                  for maximum impact!
                </p>
                <Link
                  to={"/submit/sponsor"}
