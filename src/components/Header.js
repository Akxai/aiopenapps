...
export default function Header() {
  ...
  return (
    <header className="bg-black fixed top-0 w-full z-[100]">
      <nav
      ...
      >
        <div className="flex lg:flex-1 space-x-5 items-center">
          ...
          {/* <a
            href="/"
            className="text-[18px] hidden  lg:flex font-semibold font-mont leading-6 text-white cursor-pointer hover:text-[#FF9900]"
          >
            AI Feed
          </a>
          <a
